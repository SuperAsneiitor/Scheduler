...
from orchestration.models import TaskNode
...
class ClusterScheduler:
    ...
    def submit_task(
        ...
        Args:
            task: 通常来自 :meth:`orchestration.dag_manager.DAGManager.get_ready_tasks`。
        ...
        Raises:
            TypeError: ``task`` 不是 :class:`~orchestration.models.TaskNode`。
            ValueError: 资源请求非法。
        """
