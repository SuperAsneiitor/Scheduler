...
if TYPE_CHECKING:
    from sys_config.execution_config import ExecutionConfig

from flow_controller.executors.backends.base import ExecutorJobState
from flow_controller.executors.backends.exceptions import JobNotFoundError, LocalProcessStartError
...
class LocalExecutor:
    ...
    def from_execution_config(cls, config: ExecutionConfig) -> "LocalExecutor":
        ...
        """
        from sys_config.execution_config import ExecutionConfig as ExecutionConfigModel
